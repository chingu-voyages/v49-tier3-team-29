          ...
          {isAuthenticated && (
            <>
              <Box sx={{ display: { xs: "none", sm: "block" } }}>
                ...
                <Button sx={{ color: "white" }} component={Link} to="/my-books">
                  My Books
                </Button>
              </Box>
              <Box sx={{ display: { xs: "none", sm: "block" } }}>
              ...
              <Tooltip title="Open Account Options">
                ...
                >
                  {user.userImage ? (
                    <Avatar fontSize="large" src={user.userImage}></Avatar>
                  ) : (
              ...
              >
                ...
                <MenuItem onClick={handleClose} component={Link} to="/my-books">
                  My Books
                </MenuItem>
                <Divider></Divider>
